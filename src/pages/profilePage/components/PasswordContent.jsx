...
export const PasswordContent = () => {
  ...
  return (
    <div className="p-8 bg-white h-full">
      ...
      <div>
        <h3 className="mt-4 w-full border-0 border-b-2 border-gray-300 text-[#909090] opacity-60">
          Reset Password
        </h3>
      </div>
      ...
      <section id='password'>
        <div className='mt-4'>
        <label htmlFor="old">Password Lama<span className='text-[#EE4848]'>*</span></label>
        ...
        <div className='mt-4'>
        <label htmlFor="old">Password<span className='text-[#EE4848]'>*</span></label>
        <div className=' border-[1.5px] border-[#909090] opacity-60 rounded-[.5rem] focus-within:opacity-100 transition-all p-2 flex items-center gap-2'>
          <KeyRound className='w-6 h-6 text-[#909090]' />
          <input
            id='old'
        ...
        <div className='mt-4'>
        <label htmlFor="old">Konfirmasi Password<span className='text-[#EE4848]'>*</span></label>
        <div className=' border-[1.5px] border-[#909090] opacity-60 rounded-[.5rem] focus-within:opacity-100 transition-all p-2 flex items-center gap-2'>
          <KeyRound className='w-6 h-6 text-[#909090]' />
          <input
            id='old'
        ...
        <p className='text-[#ACACAC] text-[.6rem] mt-1'>Password Anda harus memiliki minimal 8 karakter dan menyertakan huruf besar, huruf kecil, angka, serta karakter khusus.</p>
        </div>

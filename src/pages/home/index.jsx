			...
			<div className={`bg-white px-32 pb-[120px]`}>
				...
				<div>
					<div id="laporan" className="bg-gradient-to-r to-[#ED9E31] from-[#875A1C] rounded-2xl shadow-xl/30 w-[95%] md:w-[94%] mx-auto my-10 px-4 pt	-8 flex flex-col md:flex-row items-center ml-0">
						<img src="/images/Artboard 3 copy 1.png" alt="Artboard" className="w-40 md:w-60 max-w-[220px] md:max-w-[240px] mb-6 md:mb-0" />
						<div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-4">
							<h1 className="text-xl md:text-3xl lg:text-[25px] font-extrabold uppercase tracking-widest leading-tight">punya laporan yang ingin anda ajukan ?</h1>
							<h1 className="text-lg md:text-2xl font-medium capitalize">
								ajukan laporan ke <span className="uppercase">sikam</span> <br />
								sekarang!!
							</h1>
					...
					<div id="bandingukt" className="bg-gradient-to-r from-[#ED9E31] to-[#875A1C] rounded-2xl shadow-xl/30 w-[95%] md:w-[94%] mx-auto my-10 px-4 pt	-8 flex flex-col md:flex-row items-center ml-0">
						<div className="flex-1 flex flex-col items-center md:items-end text-center md:text-left gap-4">
							<h1 className="text-xl md:text-3xl lg:text-[25px] font-extrabold uppercase tracking-widest leading-tight">ingin banding ukt kalian ?</h1>
							<h1 className="text-lg md:text-2xl font-medium capitalize text-end">
								ajukan banding ukt ke{' '}
						...
						<img src="/images/Artboard 3 copy 1.png" alt="Artboard" className="w-40 md:w-60 max-w-[220px] md:max-w-[240px] mb-6 md:mb-0 scale-x-[-1]" />
					</div>
				</div>
			</div>
		</div>

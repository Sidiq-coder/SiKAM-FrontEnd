    ...
    return(
        <div className="px-10 md:px-20 lg:px-32 pb-1 pt-10">
            <div className="flex gap-34">
                <h1 className="capitalize font-bold text-[#2A2A2A] text-3xl">daftar berita</h1>
            ...
            <div className="rounded-[8px] border-[1.5px] border-[#ACACAC] flex items-center gap-2 p-2 w-full max-w-xs bg-white">
                <FontAwesomeIcon
                icon={faSearch}
                className="text-[#ACACAC] w-5 h-5 cursor-pointer"
                ...
                className="bg-transparent outline-none border-none w-full text-sm text-[#2A2A2A] placeholder-[#ACACAC] shadow-2xl"
                />
                </div>
               ...
               <div className="flex flex-col gap-4 mt-10">
                <Button href={`#`} label={`Publish`} className={`bg-[#ED9E31] text-xs text-white h-8 flex items-center hover:opacity-80 w-26`} icon={<FontAwesomeIcon icon={faDownload} flip="vertical"/>}/>
          ...
          <div className="flex flex-col justify-between w-full">
            <div>
              ...
              <p className="text-sm text-gray-600 line-clamp-3">
                {item.description}
              </p>  <span className="text-black text-sm">(Click to see more)</span>
            </div>

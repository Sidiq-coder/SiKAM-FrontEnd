	...
	return (
		<div className={`flex items-center space-x-4 ${className}`}>
			<div className="relative">
				<select className="bg-[#ED9E31] px-10 py-2 rounded-lg font-medium appearance-none pr-8 cursor-pointer" value={selectedFilter} onChange={(e) => setSelectedFilter(e.target.value)}>

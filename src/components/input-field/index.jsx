...
const InputField = ({ name, label, placeholder = '', type = 'text', register, error, icon: Icon = null, isPassword = false, isForgotPassword = false, isSmall = false }) => {
		...
		<div>
			{type === 'checkbox' ? (
				<label className="flex items-center space-x-2">
					<input type="checkbox" {...register(name)} className="h-4 w-4 text-primary border-gray-300 rounded focus:ring-blue-500" />
